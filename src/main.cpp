...
uint256 hashGenesisBlock("0xcb2bea09de2fe2e533e43ccd69eb282ad689f725c2723b65535f7c62192a7ab6");
...
const string strMessageMagic = "AnHeroCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60 * 60; // AnHeroCoin: 1 days
static const int64 nTargetSpacing = 120; // AnHeroCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal anherocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AnHeroCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x60d0d81c00e77027cc8b8a2f4c18941528dd92bbdf073cf0d296338e55903442");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Linny Boyette has passed away";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388539194; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2401170;

        if (fTestNet)
        {
            block.nTime    = 1388534471;
            block.nNonce   = 574401;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa446caa008d7fe64a7dbbe3e71515a6e8a2c260d4d4abbd5897c9e2e2c14a03a"));
